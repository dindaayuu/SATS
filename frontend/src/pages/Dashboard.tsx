...
export default function Dashboard() {
  ...
  const fetchDashboard = async () => {
    try {
      ...
      setAvailableBags(res.data.available_bags || []);
      setUsedBags(res.data.used_bags || []);
    } catch (err) {
      console.log(err);
    }
  };
    ...
    <div className="dashboard">
      ...
      <div className="header">
        ...
        <div className="header-left">
          ...
          <div className="title">
            <h1>SATS</h1>
            <p>Smart Asset Tracking Saloka</p>
          </div>
      ...
      <div className="menu-grid">
        ...
        <Link to="/pickup" className="menu-card">
